...
import authRoutes from "../modules/auth/auth/auth.routes.js";
...
import taskRoutes from "../modules/projects/tasks/task/task.routes.js";
...
app.use("/api/v1/users", authenticate, profileRoutes);
